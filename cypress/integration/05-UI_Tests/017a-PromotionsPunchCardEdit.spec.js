describe('017a - Edit Promotion Punch Card', function () 
{
    it('Edit Punch Card Promotion', function()
    {
        // Login
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Punch Card Automatic Test');
        ...
        cy.get('[data-cy="promotion-name"]').clear({force : true}).type('Punch Card Automatic Test Edit');
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Punch Card Automatic Test Edit');
        cy.wait(2000);

        cy.get('.v-switch-label:first').should('contain','ACTIVE');

        // Check new name
        cy.get('[data-cy$=title]:first').should('contain','Punch Card Automatic Test Edit');
