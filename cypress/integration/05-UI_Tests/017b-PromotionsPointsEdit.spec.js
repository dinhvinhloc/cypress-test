describe('017b - Edit Promotion Point Perks', function () 
{
    it('Edit Promotion Point Perks', function()
    {
        // Login
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Point Perk Automatic Test');
        ...
        cy.get('[data-cy="promotion-name"]').clear({force : true}).type('Point Perk Automatic Test Edit');
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Point Perk Automatic Test Edit');
        cy.wait(2000);

        // Check new name
        cy.get('[data-cy$=title]:first').should('contain','Point Perk Automatic Test Edit');
