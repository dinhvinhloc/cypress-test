describe('017i - Edit Promotion - Bundle Deal', function () 
{
    it('Bundle Deal Promotion', function()
    {
        // Login
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Bundle Deal');
        ...
        cy.get('[data-cy="promotion-name"]').clear({force : true}).type('Bundle Deal Automatic Test Edit');
        ...
        cy.get('[data-cy="top-input-search"]').clear({force : true}).type('Bundle Deal Automatic Test Edit');
        cy.wait(1000);

        // Check new name
        cy.get('[data-cy$=title]:first').should('contain','Bundle Deal Automatic Test Edit');
