describe('API011e - Setting the Promotion status to difference statues', function () {
    it('Business Category: should allow you to set the Promotion status to difference statues', function () {
        ...
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'INACTIVE',pointPerkID));
        ...
        cy.waitUntil(()=> cy.getPromotionByID(pointPerkID).then((PointPerk)=>{
            ...
            expect(PointPerk).to.have.property('status', status);
        }));
        
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'ACTIVE',pointPerkID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMABLE',pointPerkID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMED',pointPerkID));
        ...
        cy.waitUntil(()=> cy.updatePromotionStatusAllowFail('DELETED',pointPerkID).then((response) =>{
        ...
        // Create Punch Card, set to difference statuses and check
        ...
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'INACTIVE',punchCardID));

        cy.waitUntil(()=> cy.getPromotionByID(punchCardID).then((punchCardID)=>{
            expect(punchCardID).to.have.property('name', punchCardInfo.name);
            expect(punchCardID).to.have.property('description', punchCardInfo.description);
            expect(punchCardID).to.have.property('status', status);
        }));
        
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'ACTIVE',punchCardID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMABLE',punchCardID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMED',punchCardID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'DELETED',punchCardID));

        cy.waitUntil(()=> cy.updatePromotionStatusAllowFail('DELETED',punchCardID).then((response) =>{
            expect(response).to.have.property('status', 400);
        }));
        ...
        // Create Deal and set to difference statuses
        ...
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'INACTIVE',dealID));

        cy.waitUntil(()=> cy.getPromotionByID(dealID).then((dealID)=>{
            expect(dealID).to.have.property('name', dealInfo.name);
            expect(dealID).to.have.property('description', dealInfo.description);
            expect(dealID).to.have.property('status', status);
        }));

        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'ACTIVE',dealID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMABLE',dealID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMED',dealID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'DELETED',dealID));

        cy.waitUntil(()=> cy.updatePromotionStatusAllowFail('DELETED',dealID).then((response) =>{
            expect(response).to.have.property('status', 400);
        }));
        ...
        // Create a Reward and set to difference statuses
        ...
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'INACTIVE',rewardItemID));
        
        cy.waitUntil(()=> cy.getPromotionByID(rewardItemID).then((rewardItemID)=>{
            expect(rewardItemID).to.have.property('name', rewardItemInfo.name);
            expect(rewardItemID).to.have.property('description', rewardItemInfo.description);
            expect(rewardItemID).to.have.property('status', status);
        }));
        
        cy.waitUntil(()=> cy.updatePromotionStatus(status = 'ACTIVE',rewardItemID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMABLE',rewardItemID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'REDEEMED',rewardItemID));
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'DELETED',rewardItemID));

        cy.waitUntil(()=> cy.updatePromotionStatusAllowFail('DELETED',rewardItemID).then((response) =>{
            expect(response).to.have.property('status', 400);
        }));
