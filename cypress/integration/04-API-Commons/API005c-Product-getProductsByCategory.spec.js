describe('API005c - Get Merchant\'s Products by Category using API', function () {
    it('Business Category: should allow you to Get Merchant\'s Products by Category using API', function () {
        ...
        cy.waitUntil(() => cy.getProductsByCategory(productInfo.categories[0]).then((products) => {
        ...
        // Negative Test - Getting Products with the wrong category string.
        cy.waitUntil(() => cy.getProductsByCategoryClone('Improper').then((response) => {
