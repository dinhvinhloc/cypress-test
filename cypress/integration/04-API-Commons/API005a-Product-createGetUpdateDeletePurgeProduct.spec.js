describe('API005a - Create/Get/Update/Update/Delete/Purge Status Product using API', function () {
    it('Business Category: should allow you to Create/Get/Update/Update Status Product using API and then delete and purge', function () {
