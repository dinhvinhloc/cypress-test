describe('API011g - Get All Promotions of Merchant by Status', function () {
    it('Business Category: should allow you to Get All Promotions of Merchant by Status', function () {
        ...
        // Set the statuses and check
        var status = 'ACTIVE';

        cy.waitUntil(()=> cy.getPromotionsByStatus(status).then((promotions)=>{
            ...
            expect(promotions[promotions.length-1]).to.have.property('status', status);
            ...
            expect(promotions[promotions.length-2]).to.have.property('status', status);
            ...
            expect(promotions[promotions.length-3]).to.have.property('status', status);
            ...
            expect(promotions[promotions.length-4]).to.have.property('status', status);
        ...
        // cy.waitUntil(()=> cy.updatePromotionStatus(status = 'DELETED',pointPerkID));
