describe('API007c - Get all Merchant\'s Addons by Store using API', function () {
    it('Business Category: should allow you to Get Merchant\'s Addons by Store using API', function () {
        ...
        // Getting the Addon 1 Information from the fixture
        ...
        // Creating the Addon 1 in the Database.
        ...
        // Getting Addons of a particular Category.
        cy.waitUntil(() => cy.getAddonsByStore(storeID).then((addons) => {
