describe('API011i - Get All Promotions of Merchant by Type', function () {
    it('Business Category: should allow you to Get All Promotions of Merchant by Type', function () {
        ...
        // Get Promotions by Types

        cy.waitUntil(()=> cy.getPromotionByType('REWARD_ITEM').then((promotions)=>{
        ...
        cy.waitUntil(()=> cy.getPromotionByType('DEAL').then((promotions)=>{
            expect(promotions[promotions.length-1]).to.have.property('name', dealInfo.name);
            expect(promotions[promotions.length-1]).to.have.property('description', dealInfo.description);
        }));

        cy.waitUntil(()=> cy.getPromotionByType('PUNCH_CARD').then((promotions)=>{
            expect(promotions[promotions.length-1]).to.have.property('name', punchCardInfo.name);
            expect(promotions[promotions.length-1]).to.have.property('description', punchCardInfo.description);
        }));

        cy.waitUntil(()=> cy.getPromotionByType('POINT_PERK').then((promotions)=>{
            expect(promotions[promotions.length-1]).to.have.property('name', pointPerkInfo.name);
            expect(promotions[promotions.length-1]).to.have.property('description', pointPerkInfo.description);
        }));
