describe('API011h - Get All Promotions of Merchant by Store', function () {
    it('Business Category: should allow you to Get All Promotions of Merchant by Store', function () {
        ...
        cy.waitUntil(()=> cy.getPromotionsByStore(storeID).then((promotions)=>{
