describe('API005b - Get all Merchant\'s Product using API', function () {
    it('Business Category: should allow you to Get all Merchant\'s Product using API', function () {
        ...
        cy.waitUntil(() => cy.getAllProductsOfMerchant().then((products) => {
