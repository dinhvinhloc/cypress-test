describe('API005d - Get Merchant\'s Products by Store using API', function () {
    it('Business Category: should allow you to Get Merchant\'s Products by Store using API', function () {
        ...
        cy.waitUntil(()=> cy.getProductsByStore(storeID).then((products)=>{
