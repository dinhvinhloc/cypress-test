describe('API012i5 - Apply Buy One Get One Free Deal - highlightInProductList', function () {
    it('Business Category: Buy One Get One Free Deal should be suggested when the product selected is in the Highlight List', function () {
