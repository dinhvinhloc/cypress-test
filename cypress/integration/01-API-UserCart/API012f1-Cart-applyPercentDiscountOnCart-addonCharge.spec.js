describe('API012f1 - Percent Discount on Cart  - Free Addon', function () {
    it('Test the Percent Discount on Cart where isAddonCharge = false', function () {
        ...
        cy.waitUntil(() => cy.addItemToCart(store1.storeID.id,store1.PG3P5.id,5,store1.AG3AO1.id,1).then((response)=>{
            ...
            expect(response).to.have.property('discountAmount', 59.815);
