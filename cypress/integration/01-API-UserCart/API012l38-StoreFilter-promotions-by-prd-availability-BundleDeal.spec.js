...
describe('API012l38 - Promotion availability based on Products availability - Bundle Deal', function () {
    it('GET store detail by storeId - filter Promotion based on availability - Bundle Deal', function () {
        ...
        cy.wrap(store1).then(()=>{
            deal = Object.assign({}, store1.bundle100CADP3ALLGROUP)
            requiredProduct1 = Object.assign({}, store1.PG1P3)
            requiredProduct2 = Object.assign({}, store1.PG2P3)
            requiredProduct3 = Object.assign({}, store1.PG3P3)
        ...
        // bundle100CADP3ALLGROUP is not in the promotions list
...
;
        ...
        cy.waitUntil(() => cy.updateProduct(store1.PG2P3,store1.PG2P3.id));
        cy.wrap(store1).then(()=>{
            deal = Object.assign({}, store1.bundle100CADP3ALLGROUP)
            requiredProduct1 = Object.assign({}, store1.PG1P3)
            requiredProduct2 = Object.assign({}, store1.PG2P3)
        ...
        // ---------------------
        // Reset bundle100CADP3ALLGROUP and all products to original
        ...
        cy.waitUntil(() => cy.updateProduct(store1.PG1P3,store1.PG1P3.id));
        cy.waitUntil(() => cy.updateProduct(store1.PG2P3,store1.PG2P3.id));
        cy.waitUntil(() => cy.updateProduct(store1.PG3P3,store1.PG3P3.id));

        // cy.waitUntil(() => cy.updatePointPerk(store1.bundle100CADP3ALLGROUP,store1.bundle100CADP3ALLGROUP.id));
