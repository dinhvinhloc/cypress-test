describe('API012h3 - Fixed Discount on Item - maxRedeem = 1', function () {
    it('Test the Fixed Discount on Item where maxRedeem = 1', function () {
        ...
        // Add PG2P2 and addon, expect to have discount on that product and addon
        ...
        // Add PG3P5 and addon, expect no more discount
