describe('API012h2 - Fixed Discount on Item  - isPublicAvailable', function () {
    it('Test the Fixed Discount on Item where isPublicAvailable = false', function () {
        ...
        cy.waitUntil(() => cy.addItemToCart(store1.storeID.id,store1.PG2P2.id,2,store1.AG2AO1.id,1).then((response)=>{
            console.log(response);
