describe('API012n2 - Point Perk Promotion - isNewClient = true', function () {
    it('Test the Point Perk Promotion on Item where isNewClient = true', function () {
        ...
        // Add 1 PG3P6 to the cart and promotion should'nt be added because enduser is not new client (Has old orders)
