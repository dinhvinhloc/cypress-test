describe('API012h4 - Fixed Discount on Item - isNewClient = true', function () {
    it('Test the Fixed Discount on Item where isNewClient = true', function () {
        ...
        // Add 5 PG2P2 to the cart expect no promotions applied
        var rewardItem
        cy.waitUntil(() => cy.addItemToCart(store1.storeID.id,store1.PG2P2.id,5,store1.AG2AO1.id,1).then((response)=>{
            console.log(response);
