...
describe('API012l36 - Promotion availability based on Products availability - Percent Discount on Item', function () {
    it('GET store detail by storeId - filter Promotion based on availability - Percent Discount on Item', function () {
        ...
        let rewardProduct
        cy.wrap(store1).then(()=>{
            deal = Object.assign({}, store1.dis10PerPG2P2)
            rewardProduct = Object.assign({}, store1.PG2P2)
        })
        ...
        // dis10PerPG2P2 is not in the promotions list
        ...
        cy.waitUntil(() => cy.updateProduct(store1.PG2P2,store1.PG2P2.id));
        cy.wrap(store1).then(()=>{
            deal = Object.assign({}, store1.dis10PerPG2P2)
            rewardProduct = Object.assign({}, store1.PG2P2)
        })
        ...
        // ---------------------
        // Reset dis10PerPG2P2 and all products to original
        ...
        cy.waitUntil(() => cy.updateProduct(store1.PG2P2,store1.PG2P2.id));
        // cy.waitUntil(() => cy.updateRewardItem(store1.dis10PerPG2P2,store1.dis10PerPG2P2.id));
