describe('API014a4 - Test the Order will not be able to confirm in case Promotion/Product/Addon is INACTIVE', function () {
    it('Test the Order will not be able to confirm in case Promotion/Product/Addon is INACTIVE', function () {
