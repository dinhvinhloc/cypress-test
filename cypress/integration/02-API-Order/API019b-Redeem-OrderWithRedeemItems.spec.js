describe('API019b - User and merchant is able to process the order with redeem items', function () {
    it('Verify that user/merchant is able to process the order with redeem items (punch card and reward)', function () {

        // Test points:
        // 1. Add 2 Punch Card promotions' items into the cart. One Punch Card Redeem twice as much at a time
        // 2. Add 2 Reward Promotions' items into the cart. One Reward Redeem twice as much at a time
        // 3. Add regular items that meet one Punch Card promotion. Check the increment of the punches.
        // 4. User process to checkout, confirm and pay
        // 5. Merchant is able to process the order to the end
