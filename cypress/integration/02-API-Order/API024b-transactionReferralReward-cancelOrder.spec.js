describe('API024b - Test transactional referral reward will not be added if order is canceled', function () {
    it('Test that the referrers at each leavel will not be added if order is canceled', function () {
