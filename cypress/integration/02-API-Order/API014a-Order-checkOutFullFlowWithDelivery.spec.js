describe('API014a - Test the Order main flow and misc functions', function () {
    it('Verify the order main flow: Checkout, Confirm, Pay, confirmPaid, accept, ready, preparing, delivering, complete ', function () {
        ...
        // const now = Cypress.dayjs().add(5,'minutes').format()
        // const then = Cypress.dayjs().add(-1,'minutes').format()
        ...
        cy.waitUntil(() => cy.getOrderByID(order.id).then((response)=>{
            ...
            cy.assertDeliveryTax(5,10,response.deliveryAppliedTaxes)
